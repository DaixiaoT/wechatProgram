Page({
   ...
   */
  onLoad(options) {
    this.getSeniorChapters()
    this.getBasicChapters()
    this.getBooks()
    this.getExperiences()
  ...
  getBasicChapters() {
    ...
    wx.request({
      url: 'https://mock.presstime.cn/mock/64fbe5f62b33b5907f45a8ef/embed/basic/chapter',
      method: 'get',
      success: ({
        data: res
      }) => {
  ...
  getSeniorChapters() {
    ...
    wx.request({
      url: 'https://mock.presstime.cn/mock/64fbe5f62b33b5907f45a8ef/embed/senior/chapter',
      method: 'get',
      success: ({
        data: res
      }) => {
  ...
  getBooks() {
    ...
    wx.request({
      url: 'https://mock.presstime.cn/mock/64fbe5f62b33b5907f45a8ef/embed/book/list',
      method: 'get',
      success: ({
        data: res
      }) => {
  ...
  getExperiences() {
    ...
    wx.request({
      url: 'https://mock.presstime.cn/mock/64fbe5f62b33b5907f45a8ef/embed/experience/list',
      method: 'get',
      success: ({
        data: res
      }) => {
